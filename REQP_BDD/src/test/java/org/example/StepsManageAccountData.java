...
public class StepsManageAccountData {
   ...
   @Then("the system should validate the payment details")
    ...
    public void testAddFunds() {
        ...
        assertEquals(customer.viewBalance(), initialBalance + 100.0);
        assertNotEquals(customer.viewBalance(), initialBalance, 0.0);
        assertNotEquals(0.0, customer.viewBalance(), 0.0);
    ...
    public void testViewBalance() {
        ...
        assertFalse(false);
        assertNotEquals(0.0, balance, 0.0);
        assertEquals(50.0, balance);
        assertEquals("John Doe", customer.getCustomerName());
    }
